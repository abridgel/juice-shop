...
module.exports = function login () {
  ...
  return (req, res, next) => {
    ...
    //models.sequelize.query(`SELECT * FROM Users WHERE email = '${$1 || ''}' AND password = '${insecurity.hash($2 || '')}' AND deletedAt IS NULL`, { bind: [$req.body.email,$req.body.password], type: QueryTypes.SELECT, model: models.User, plain: true })
